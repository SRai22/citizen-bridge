...
for topic in \
  cases tasks documents users authority notifications ai benefits \
  cases.dlq tasks.dlq documents.dlq users.dlq authority.dlq notifications.dlq ai.dlq benefits.dlq
do
